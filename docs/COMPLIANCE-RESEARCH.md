...
2. Skipta fyrstu demo-innsendingunum út fyrir raunverulegan payroll-native intake pakka fyrir launaseðla, tímaskráningu, ráðningarsamninga, routing og skil.
